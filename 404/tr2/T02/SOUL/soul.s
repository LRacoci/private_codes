...
IRQ_HANDLER:
	...
	@ Atualiza o endereço do contador
	ldr r2, =CONTADOR
	@ Carega o contador
	ldr r0, [r2]
	add r0, r0, #1
...
.set DEFAULT_STACK_SIZE, 	0x800

.set FIQ_STACK_SIZE, 		DEFAULT_STACK_SIZE
.set IRQ_STACK_SIZE, 		DEFAULT_STACK_SIZE
.set SVC_STACK_SIZE, 		DEFAULT_STACK_SIZE
.set ABT_STACK_SIZE, 		DEFAULT_STACK_SIZE
.set UND_STACK_SIZE, 		DEFAULT_STACK_SIZE

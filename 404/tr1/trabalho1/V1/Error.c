...
Exception aux_exception_creator(TypeException _type, bool _complete, String _msg, unsigned short int _line){
...
Exception start_warning_exception(String _msg){
	return aux_exception_creator(WARNINGfalse, _msg, -1);
}
